...
<title>SoleMate View Product</title>
<!-- InstanceEndEditable -->
...
<p>&nbsp;    </p>
	...
	if(isset($_GET['pid']))
	$_SESSION['lastpid'] = $_GET['pid'];
	$result = mysql_query("Select * from Product where ProductID = '".$_SESSION['lastpid']."'");
	$row = mysql_fetch_row($result);
	echo "<table cellspacing=\"10\" align=\"center\">";
	echo "<tr>";
	echo '<td rowspan="6"><img src= http://localhost/SoleMate/image.php width="157" height="195"></td>';
	echo "<td>$row[5] $row[4]</td>";
	echo "</tr>";
	echo "<tr>";
	echo "<td>This product is available in all sizes</td>";
	echo "</tr>";
	echo "<tr>";
	echo "<td>Price: Rs. $row[3]</td>";
	echo "</tr>";
	echo "<tr>";
	echo "<td>Type: $row[6]</td>";
	echo "</tr>";
	...
	{
	echo "<form action=\"http://ww7.aitsafe.com/cf/add.cfm\" method=\"post\">";
	echo "<input name=\"userid\" type=\"hidden\" value=\"97248120\">";
	echo "<input name=\"product[]\" type=\"hidden\" value=\"$row[5] $row[4]\">";
	echo "Size: ";
	echo "<select name=\"product[]\">";
    echo "<option value=\"Size 6\"> 6 </option>";
    echo "<option value=\"Size 7\"> 7 </option>";
	echo "<option value=\"Size 8\"> 8 </option>";
	echo "<option value=\"Size 9\"> 9 </option>";
	echo "<option value=\"Size 10\"> 10 </option>";
	echo "<option value=\"Size 11\"> 11 </option>";
	echo "</select>";
	echo "</td>";
	echo "</tr>";
	echo "<tr>";
	echo "<td>";
	echo "<input name=\"price\" type=\"hidden\" value=$row[3]>";
	echo "<input name=\"return\" type=\"hidden\" value=\"http://localhost/SoleMate/temp.php\">";
	echo "<input type=\"submit\" value=\"Buy Now!\">";
	echo "</form>";
	}
	else
	{
		echo "Please sign-in to buy this product";
	}
	echo "</td>";
	echo "</tr>";
	echo "</table>";
